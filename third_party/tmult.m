% THIRD-PARTY-STYLE utility shipped in cjz2019_ad_opthyper/legacy/MatCode/tmult.m; kept here
% because AD_ML's GetA calls it while AD_OptHyper ships it - the AD packages fill each other's gaps.
