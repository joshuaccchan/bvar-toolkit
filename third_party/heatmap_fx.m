% THIRD-PARTY CODE - do not edit as Chan code. MathWorks File Exchange heatmap (2009-2014),
% shipped in the chan_koop_yu2024_jbes_oisv legacy package. RENAMED heatmap -> heatmap_fx because
% the original shadows MATLAB's built-in heatmap (R2017a+) on any merged path.
function [hImage, hText, hXText] = heatmap_fx(mat, xlab, ylab, textmat, varargin)
