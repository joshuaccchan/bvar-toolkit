function prior=prior_AD(ax,s,o,a0,Va,nusig2,Ssig2,nuomega2,Somega2)
[R,na]=size(ax.v);
n=size(s.v,1);
r=size(o.v,1);
err.v=ax.v-a0;
...
err.d=0.5/Va*err.d-0.5/Va^2*err.v*[0,1,0,0];
err.v=0.5/Va*err.v;
prior.v=-na/2*log(2*pi*Va)-err.v;
prior.d=-na/(2*Va)*ones(R,1)*[0,1,0,0]-err.d;
...
l_sig.d=v*[0,0,1,0]-(nusig2+1)*L.d-(nusig2-1)*L2.d;
...
l_omega.d=v*[0,0,0,1]-(nuomega2+1)*L.d-(nuomega2-1)*L2.d;
