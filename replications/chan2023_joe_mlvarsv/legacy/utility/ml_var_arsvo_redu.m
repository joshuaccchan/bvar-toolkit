% This function computes the marginal likelihood of VAR-SVO
%    
% See:
...
function [lml,lmlstd] = ml_var_arsvo_redu(X,Y,Y0,M,Hyper,flag_marg,store_h,...
...
for isim = 1:M
    ...
    diag_sqrt_D = vec(exp(h/2).*repmat(o,1,n));
    ...
    lr_o = sum(o_lpri(o_idx) - log(o_hat(o_idx)));
    if is_kappafixed        
