% This function estimates a large Bayesian VAR with the normal-gamma prior
%
% See:
...
start_time = clock;
disp('Starting MCMC for BVAR-NG.... ');

for isim = 1:nsim + burnin
        % sample alp and beta    
    [Valp,Vbeta] = getVtheta(idx_kappa1,idx_kappa2,[kappa,kappa,1,100],Psi,sig2);
    count_alp = 0;
    U = zeros(T,n);
    for ii = 1:n
        yi = Y(:,ii);
...
xlabel('Histogram of posterior draws of \kappa'); box off;
