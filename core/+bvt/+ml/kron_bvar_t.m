% bvt.ml.kron_bvar_t - log marginal likelihood of the BVAR-t model of
...
%   bvt.ml.lniwpdf). CLEAN BILL (step-8 audit): every ordinate is evaluated
...
%
%   [ML, out] = bvt.ml.kron_bvar_t(shortY, X, pri, est)
%
...
lpri = bvt.ml.lniwpdf(A_mean,Sig_mean,A0,sparse(1:k,1:k,1./VA0),nu0,S0) + log(1/(nuub-2));
