% bvt.ml.kron_bvar_t_ma - log marginal likelihood of the BVAR-t-MA model of
...
%
%   [ML, out] = bvt.ml.kron_bvar_t_ma(shortY, X, pri, est)
%
...
for isim = 1:nsims
    ...
    % sample psi
    lp_psi = @(x) bvt.ml.llike_csv_ma(x,U,Sig_mean,log(lam)) + lpri_psi(x);
