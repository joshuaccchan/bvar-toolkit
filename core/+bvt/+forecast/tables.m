% bvt.forecast.tables - forecast-evaluation accumulation and RMSFE / average
...
%
%   row = bvt.forecast.tables('accum_row', tmpyhat, obs)
...
%     matrix from bvt.forecast.iterate ([point forecasts, per-variable log
...
%     imaginary part (see bvt.forecast.iterate header; on R2025b diag() demotes
...
%
%   S = bvt.forecast.tables('springer', yhat0, yhat1, var_core)
...
switch action
    ...
    otherwise
        error('bvt:forecast:tables:unknownAction', ...
