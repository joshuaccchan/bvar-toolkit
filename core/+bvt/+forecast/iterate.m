% bvt.forecast.iterate - one iterated-forecast + predictive-likelihood step for
...
%
%   fc = bvt.forecast.iterate(branch, draw, cfg)
%
...
% table stage (bvt.forecast.tables).
%
...
switch branch
    ...
    otherwise
        error('bvt:forecast:iterate:unknownBranch', ...
