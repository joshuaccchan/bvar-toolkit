% bvt.priors.acp_redu - asymmetric conjugate prior elicited on the
...
% bvt.priors.acp_stru(...) (itself verbatim from the same R1 package).
...
k_beta = n*(n*p+1);
prior_stru = bvt.priors.acp_stru(n,p,kappa,sig2,idx_ns);
