% bvt.util.surform - T x Tk BLOCK-DIAGONAL sparse SUR expansion (TVP state stacking).
% NOT the same operator as bvt.util.surform2 (n-row Kronecker expansion) - see headers.
