% bvt.util.anormrnd - one draw from the two-component (bimodal) normal
...
% bvt.structural.b0_row_sampler's canonical block). Only the namespace was
% added; nothing renamed or parameterized. Model-specific draw - do NOT fold
% into bvt.util.tnormrnd (a truncated-normal sampler; entirely different
