% bvar.ml.kron_bvar - log marginal likelihood of the standard (homoskedastic,
...
ML = llike + bvar.ml.lniwpdf(A,Sig,A0,sparse(1:k,1:k,1./VA0),nu0,S0) ...
    - bvar.ml.lniwpdf(A,Sig,Ahat,KA,nu0+T,Shat);
