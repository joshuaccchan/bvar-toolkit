...
| Package | Entry | Runtime | Notes |
|---|---|---|---|
| `cjz2018_ad_var` | `main_AD_VAR.m` | min-hours | Needs System Identification Tbx (`ar()` in Min_Prior) + Stats Tbx + deprecated `xlsread`. 15 globals; run standalone only. BLOCKED 2026-09-01: the toolbox is licensed but not installed on this machine - `ar` undefined; error golden captured. Install via Add-On Explorer to capture a numeric golden. |
