% GOLDEN-RUN VARIANT PATCH (2026-09-01): identical to legacy/main_varsv.m except
% the model selector below is set to 5 (VAR-SVO) instead of the shipped default 2
% (VAR-CSV), to capture marginal-likelihood goldens for every model in the paper.
