%% GOLDEN-RUN VARIANT PATCH (2026-09-01): identical to legacy/main_ACP_apps.m except
%% dataset = 2 instead of the shipped default 1, to capture the 15-variable
%% sign-restriction golden (nsim=1000 accepted draws; documented as multi-day).
