...
% deterministic: bvar.priors.minn with n0pre = 4 reproduces ml_varsv's
...
[b1, V1, S1, U1] = bvar.priors.minn(p, c1, c2, c3, Y0, Yt, 4);
...
p4 = 4;
[b3, V3, S3] = bvar.priors.minn(p4, c1, c2, c3, Y0, Yt, p4);
