...
n = 5; p = 3;
sig2 = exp(randn(n, 1));
[C, idx_kappa1, idx_kappa2] = bvt.priors.minnesota_C(n, p, sig2);
...
[Va0, Vb0] = bvt.priors.vtheta(idx_kappa1, idx_kappa2, kappa, C, sig2);
...
[Va0, Vb0] = bvt.priors.vtheta(idx_kappa1, idx_kappa2, [kappa(1); kappa(2); .2; 1], C, sig2);
