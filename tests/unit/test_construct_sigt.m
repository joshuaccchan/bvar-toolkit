...
% exact equivalence of bvar.structural.construct_Sigt with the legacy OISV
...
S1 = bvar.structural.construct_Sigt(h, B0);
...
assert(isequal(construct_Sigt(h, A), bvar.structural.construct_Sigt(h, A)), ...
